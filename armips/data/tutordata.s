...
TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_MAGICAL_LEAF | TUTOR_MOVE_CHARM,\
...
TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_MAGICAL_LEAF | TUTOR_MOVE_CHARM,\
...
TUTOR_MOVE_GYRO_BALL | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL | TUTOR_MOVE_AURA_SPHERE | TUTOR_MOVE_FLIP_TURN,\
...
TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_GYRO_BALL | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL | TUTOR_MOVE_AURA_SPHERE | TUTOR_MOVE_DRAGON_TAIL | TUTOR_MOVE_FLIP_TURN,\
...
TUTOR_MOVE_AIR_CUTTER | TUTOR_MOVE_DRAINING_KISS | TUTOR_MOVE_ELECTROWEB | TUTOR_MOVE_OMINOUS_WIND | TUTOR_MOVE_PSYBEAM | TUTOR_MOVE_SILVER_WIND | TUTOR_MOVE_DUAL_WINGBEAT,\
...
TUTOR_MOVE_AIR_CUTTER | TUTOR_MOVE_BRUTAL_SWING | TUTOR_MOVE_ELECTROWEB | TUTOR_MOVE_OMINOUS_WIND | TUTOR_MOVE_SILVER_WIND | TUTOR_MOVE_DRILL_RUN,\
TUTOR_MOVE_KNOCK_OFF | TUTOR_MOVE_DOUBLE_EDGE

tutordata SPECIES_PIDGEY,\
TUTOR_MOVE_AIR_CUTTER | TUTOR_MOVE_OMINOUS_WIND | TUTOR_MOVE_HEAT_WAVE,\
...
TUTOR_MOVE_AIR_CUTTER | TUTOR_MOVE_OMINOUS_WIND | TUTOR_MOVE_DRILL_RUN | TUTOR_MOVE_HEAT_WAVE,\
...
TUTOR_MOVE_SEED_BOMB | TUTOR_MOVE_SUCKER_PUNCH | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_GUNK_SHOT

tutordata SPECIES_ARBOK,\
TUTOR_MOVE_ACID_SPRAY | TUTOR_MOVE_BRUTAL_SWING | TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_AQUA_TAIL | TUTOR_MOVE_DRAGON_TAIL,\
TUTOR_MOVE_SEED_BOMB | TUTOR_MOVE_SUCKER_PUNCH | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_GUNK_SHOT
...
TUTOR_MOVE_DRAINING_KISS | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_INCINERATE | TUTOR_MOVE_MAGICAL_LEAF | TUTOR_MOVE_SHOCK_WAVE | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_CHARM | TUTOR_MOVE_DUAL_WINGBEAT | TUTOR_MOVE_FIRE_PUNCH,\
...
TUTOR_MOVE_PSYBEAM | TUTOR_MOVE_CROSS_POISON,\
...
TUTOR_MOVE_ACID_SPRAY | TUTOR_MOVE_AIR_CUTTER | TUTOR_MOVE_OMINOUS_WIND | TUTOR_MOVE_POUNCE | TUTOR_MOVE_PSYBEAM | TUTOR_MOVE_SILVER_WIND,\
TUTOR_MOVE_SIGNAL_BEAM | TUTOR_MOVE_ZEN_HEADBUTT | TUTOR_MOVE_DOUBLE_EDGE
...
TUTOR_MOVE_ACID_SPRAY | TUTOR_MOVE_MAGICAL_LEAF,\
...
TUTOR_MOVE_ACID_SPRAY | TUTOR_MOVE_BRUTAL_SWING | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_CROSS_POISON,\
...
TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_INCINERATE | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_CHARM | TUTOR_MOVE_HEAT_WAVE,\
TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_FLARE_BLITZ | TUTOR_MOVE_PLAY_ROUGH | TUTOR_MOVE_WILD_CHARGE

tutordata SPECIES_RAPIDASH,\
TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_INCINERATE | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_CHARM | TUTOR_MOVE_DRILL_RUN | TUTOR_MOVE_HEAT_WAVE,\
...
TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL | TUTOR_MOVE_DRILL_RUN,\
...
TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE,\
TUTOR_MOVE_KNOCK_OFF | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_SUPERPOWER

tutordata SPECIES_KINGLER,\
TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_BRUTAL_SWING | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE,\
...
TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_SHOCK_WAVE,\
TUTOR_MOVE_KNOCK_OFF | TUTOR_MOVE_SEED_BOMB | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_POWER_WHIP
...
TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_FLIP_TURN,\
...
TUTOR_MOVE_GYRO_BALL | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_PSYBEAM | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_FLIP_TURN,\
...
TUTOR_MOVE_DRAINING_KISS | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_CHARM,\
...
TUTOR_MOVE_BRUTAL_SWING | TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT,\
...
TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_SHOCK_WAVE | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL | TUTOR_MOVE_CHARM | TUTOR_MOVE_DRILL_RUN,\
...
TUTOR_MOVE_HYPER_VOICE | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_FLARE_BLITZ | TUTOR_MOVE_STORED_POWER | TUTOR_MOVE_SUPERPOWER
...
TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_GYRO_BALL | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE,\
...
TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL | TUTOR_MOVE_CROSS_POISON | TUTOR_MOVE_FLIP_TURN,\
...
TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_MAGICAL_LEAF,\
TUTOR_MOVE_SEED_BOMB | TUTOR_MOVE_DOUBLE_EDGE
...
TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_MAGICAL_LEAF | TUTOR_MOVE_DRAGON_TAIL,\
TUTOR_MOVE_SEED_BOMB | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_OUTRAGE
...
TUTOR_MOVE_IRON_HEAD | TUTOR_MOVE_THUNDER_PUNCH | TUTOR_MOVE_ZEN_HEADBUTT | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_FLARE_BLITZ | TUTOR_MOVE_PLAY_ROUGH | TUTOR_MOVE_WILD_CHARGE

tutordata SPECIES_TOTODILE,\
TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL,\
...
TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL | TUTOR_MOVE_DRAGON_TAIL,\
TUTOR_MOVE_ICE_PUNCH | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_HYDRO_PUMP | TUTOR_MOVE_OUTRAGE | TUTOR_MOVE_SUPERPOWER
...
TUTOR_MOVE_HYPER_VOICE | TUTOR_MOVE_ICE_PUNCH | TUTOR_MOVE_KNOCK_OFF | TUTOR_MOVE_SUCKER_PUNCH | TUTOR_MOVE_THUNDER_PUNCH | TUTOR_MOVE_DOUBLE_EDGE
...
TUTOR_MOVE_AIR_CUTTER | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_OMINOUS_WIND | TUTOR_MOVE_PSYBEAM | TUTOR_MOVE_SILVER_WIND,\
...
TUTOR_MOVE_ELECTROWEB | TUTOR_MOVE_PSYBEAM | TUTOR_MOVE_CROSS_POISON,\
TUTOR_MOVE_SIGNAL_BEAM | TUTOR_MOVE_SUCKER_PUNCH | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_FOUL_PLAY | TUTOR_MOVE_MEGAHORN
...
TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_PSYBEAM | TUTOR_MOVE_SHOCK_WAVE | TUTOR_MOVE_WATER_PULSE,\
...
TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_PSYBEAM | TUTOR_MOVE_SHOCK_WAVE | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL,\
TUTOR_MOVE_SIGNAL_BEAM | TUTOR_MOVE_SUCKER_PUNCH | TUTOR_MOVE_VOLT_SWITCH | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_HYDRO_PUMP | TUTOR_MOVE_WILD_CHARGE
...
TUTOR_MOVE_DRAINING_KISS | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_INCINERATE | TUTOR_MOVE_MAGICAL_LEAF | TUTOR_MOVE_SHOCK_WAVE | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_CHARM,\
...
TUTOR_MOVE_AIR_CUTTER | TUTOR_MOVE_OMINOUS_WIND | TUTOR_MOVE_SILVER_WIND | TUTOR_MOVE_DUAL_WINGBEAT | TUTOR_MOVE_HEAT_WAVE,\
TUTOR_MOVE_SIGNAL_BEAM | TUTOR_MOVE_SUCKER_PUNCH | TUTOR_MOVE_ZEN_HEADBUTT | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_FOUL_PLAY | TUTOR_MOVE_STORED_POWER
...
TUTOR_MOVE_MAGICAL_LEAF | TUTOR_MOVE_CHARM,\
...
TUTOR_MOVE_AIR_CUTTER | TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_OMINOUS_WIND | TUTOR_MOVE_SILVER_WIND,\
TUTOR_MOVE_SIGNAL_BEAM | TUTOR_MOVE_DOUBLE_EDGE
...
TUTOR_MOVE_AIR_CUTTER | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_OMINOUS_WIND | TUTOR_MOVE_HEAT_WAVE,\
...
TUTOR_MOVE_IRON_HEAD | TUTOR_MOVE_PSYCHIC_FANGS | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_EARTH_POWER | TUTOR_MOVE_HEAVY_SLAM | TUTOR_MOVE_METEOR_BEAM

tutordata SPECIES_SNUBBULL,\
TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_INCINERATE | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_SHOCK_WAVE | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_CHARM | TUTOR_MOVE_FIRE_PUNCH,\
...
TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_INCINERATE | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_SHOCK_WAVE | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_CHARM | TUTOR_MOVE_FIRE_PUNCH,\
TUTOR_MOVE_HYPER_VOICE | TUTOR_MOVE_ICE_PUNCH | TUTOR_MOVE_THUNDER_PUNCH | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_OUTRAGE | TUTOR_MOVE_PLAY_ROUGH | TUTOR_MOVE_SUPERPOWER | TUTOR_MOVE_WILD_CHARGE
...
TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE,\
...
TUTOR_MOVE_ACID_SPRAY | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_INCINERATE | TUTOR_MOVE_PSYBEAM | TUTOR_MOVE_WATER_PULSE,\
...
TUTOR_MOVE_ICE_PUNCH | TUTOR_MOVE_SEED_BOMB | TUTOR_MOVE_SIGNAL_BEAM | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_FOUL_PLAY | TUTOR_MOVE_GUNK_SHOT | TUTOR_MOVE_TRIPLE_AXEL

tutordata SPECIES_MANTINE,\
TUTOR_MOVE_AIR_CUTTER | TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_PSYBEAM | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL | TUTOR_MOVE_DUAL_WINGBEAT,\
...
TUTOR_MOVE_BREAKING_SWIPE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_FLIP_TURN,\
...
TUTOR_MOVE_DRAINING_KISS | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_CHARM,\
...
TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_OMINOUS_WIND | TUTOR_MOVE_WATER_PULSE,\
TUTOR_MOVE_IRON_HEAD | TUTOR_MOVE_SIGNAL_BEAM | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_HYDRO_PUMP
...
TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_MAGICAL_LEAF,\
...
TUTOR_MOVE_BREAKING_SWIPE | TUTOR_MOVE_BRUTAL_SWING | TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_MAGICAL_LEAF | TUTOR_MOVE_CROSS_POISON,\
...
TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL,\
...
TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL | TUTOR_MOVE_FLIP_TURN,\
...
TUTOR_MOVE_HYPER_VOICE | TUTOR_MOVE_SUCKER_PUNCH | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_FOUL_PLAY | TUTOR_MOVE_PLAY_ROUGH
...
TUTOR_MOVE_AIR_CUTTER | TUTOR_MOVE_ELECTROWEB | TUTOR_MOVE_OMINOUS_WIND | TUTOR_MOVE_SILVER_WIND,\
TUTOR_MOVE_SIGNAL_BEAM | TUTOR_MOVE_DOUBLE_EDGE
...
TUTOR_MOVE_AIR_CUTTER | TUTOR_MOVE_ELECTROWEB | TUTOR_MOVE_OMINOUS_WIND | TUTOR_MOVE_PSYBEAM | TUTOR_MOVE_SILVER_WIND,\
TUTOR_MOVE_SIGNAL_BEAM | TUTOR_MOVE_DOUBLE_EDGE

tutordata SPECIES_LOTAD,\
TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE,\
TUTOR_MOVE_SEED_BOMB | TUTOR_MOVE_ZEN_HEADBUTT | TUTOR_MOVE_DOUBLE_EDGE

tutordata SPECIES_LOMBRE,\
TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_FIRE_PUNCH,\
...
TUTOR_MOVE_AIR_CUTTER | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_LOW_KICK,\
TUTOR_MOVE_SEED_BOMB | TUTOR_MOVE_SUCKER_PUNCH | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_FOUL_PLAY

tutordata SPECIES_SHIFTRY,\
TUTOR_MOVE_AIR_CUTTER | TUTOR_MOVE_BRUTAL_SWING | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_OMINOUS_WIND | TUTOR_MOVE_SILVER_WIND | TUTOR_MOVE_HEAT_WAVE,\
...
TUTOR_MOVE_AIR_CUTTER | TUTOR_MOVE_CHILLING_WATER | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_OMINOUS_WIND | TUTOR_MOVE_POUNCE | TUTOR_MOVE_PSYBEAM | TUTOR_MOVE_SILVER_WIND | TUTOR_MOVE_WATER_PULSE,\
...
TUTOR_MOVE_AIR_CUTTER | TUTOR_MOVE_OMINOUS_WIND | TUTOR_MOVE_SILVER_WIND | TUTOR_MOVE_DUAL_WINGBEAT,\
TUTOR_MOVE_DOUBLE_EDGE
...
TUTOR_MOVE_ICE_PUNCH | TUTOR_MOVE_POWER_GEM | TUTOR_MOVE_THUNDER_PUNCH | TUTOR_MOVE_VOLT_SWITCH | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_EARTH_POWER
...
TUTOR_MOVE_ICE_PUNCH | TUTOR_MOVE_IRON_HEAD | TUTOR_MOVE_THUNDER_PUNCH | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_EARTH_POWER | TUTOR_MOVE_HEAVY_SLAM | TUTOR_MOVE_HYDRO_PUMP | TUTOR_MOVE_METEOR_BEAM | TUTOR_MOVE_OUTRAGE | TUTOR_MOVE_SUPERPOWER
...
TUTOR_MOVE_AIR_CUTTER | TUTOR_MOVE_OMINOUS_WIND | TUTOR_MOVE_SHOCK_WAVE | TUTOR_MOVE_SILVER_WIND | TUTOR_MOVE_WATER_PULSE,\
...
TUTOR_MOVE_AIR_CUTTER | TUTOR_MOVE_OMINOUS_WIND | TUTOR_MOVE_SHOCK_WAVE | TUTOR_MOVE_SILVER_WIND | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_CHARM,\
...
TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_FLIP_TURN,\
TUTOR_MOVE_PSYCHIC_FANGS | TUTOR_MOVE_ZEN_HEADBUTT | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_HYDRO_PUMP

tutordata SPECIES_SHARPEDO,\
TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_FLIP_TURN,\
...
TUTOR_MOVE_SIGNAL_BEAM | TUTOR_MOVE_THUNDER_PUNCH | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_EARTH_POWER | TUTOR_MOVE_OUTRAGE | TUTOR_MOVE_SUPERPOWER
...
TUTOR_MOVE_SEED_BOMB | TUTOR_MOVE_SUCKER_PUNCH | TUTOR_MOVE_THUNDER_PUNCH | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_FOUL_PLAY

tutordata SPECIES_CACTURNE,\
TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_MAGICAL_LEAF | TUTOR_MOVE_TRAILBLAZE,\
TUTOR_MOVE_SEED_BOMB | TUTOR_MOVE_SUCKER_PUNCH | TUTOR_MOVE_THUNDER_PUNCH | TUTOR_MOVE_ZEN_HEADBUTT | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_FOUL_PLAY | TUTOR_MOVE_SUPERPOWER
...
TUTOR_MOVE_ACID_SPRAY | TUTOR_MOVE_BRUTAL_SWING | TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_POUNCE | TUTOR_MOVE_TRAILBLAZE | TUTOR_MOVE_AQUA_TAIL | TUTOR_MOVE_DRAGON_TAIL,\
TUTOR_MOVE_IRON_HEAD | TUTOR_MOVE_KNOCK_OFF | TUTOR_MOVE_PSYCHIC_FANGS | TUTOR_MOVE_SEED_BOMB | TUTOR_MOVE_SUCKER_PUNCH | TUTOR_MOVE_ZEN_HEADBUTT | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_GUNK_SHOT
...
TUTOR_MOVE_ANCIENT_POWER,\
TUTOR_MOVE_SEED_BOMB | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_EARTH_POWER | TUTOR_MOVE_METEOR_BEAM

tutordata SPECIES_CRADILY,\
TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT,\
TUTOR_MOVE_SEED_BOMB | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_EARTH_POWER | TUTOR_MOVE_METEOR_BEAM | TUTOR_MOVE_POWER_WHIP

tutordata SPECIES_ANORITH,\
TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_CROSS_POISON,\
TUTOR_MOVE_KNOCK_OFF | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_EARTH_POWER | TUTOR_MOVE_METEOR_BEAM

tutordata SPECIES_ARMALDO,\
TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_BRUTAL_SWING | TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL | TUTOR_MOVE_CROSS_POISON,\
...
TUTOR_MOVE_BREAKING_SWIPE | TUTOR_MOVE_BRUTAL_SWING | TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL | TUTOR_MOVE_DRAGON_TAIL | TUTOR_MOVE_FLIP_TURN,\
TUTOR_MOVE_IRON_HEAD | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_HYDRO_PUMP | TUTOR_MOVE_TRIPLE_AXEL

tutordata SPECIES_CASTFORM,\
TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_INCINERATE | TUTOR_MOVE_OMINOUS_WIND | TUTOR_MOVE_SHOCK_WAVE | TUTOR_MOVE_WATER_PULSE,\
...
TUTOR_MOVE_HEX | TUTOR_MOVE_KNOCK_OFF | TUTOR_MOVE_SUCKER_PUNCH | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_FOUL_PLAY | TUTOR_MOVE_GUNK_SHOT
...
TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL,\
TUTOR_MOVE_SIGNAL_BEAM | TUTOR_MOVE_DOUBLE_EDGE
...
TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL,\
TUTOR_MOVE_SUCKER_PUNCH | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_HYDRO_PUMP

tutordata SPECIES_GOREBYSS,\
TUTOR_MOVE_DRAINING_KISS | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL,\
TUTOR_MOVE_SIGNAL_BEAM | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_HYDRO_PUMP

tutordata SPECIES_RELICANTH,\
TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL,\
...
TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_INCINERATE | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_FIRE_PUNCH | TUTOR_MOVE_HEAT_WAVE,\
TUTOR_MOVE_THUNDER_PUNCH | TUTOR_MOVE_GUNK_SHOT

tutordata SPECIES_MONFERNO,\
TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_INCINERATE | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_FIRE_PUNCH | TUTOR_MOVE_HEAT_WAVE,\
TUTOR_MOVE_THUNDER_PUNCH | TUTOR_MOVE_CLOSE_COMBAT | TUTOR_MOVE_FLARE_BLITZ | TUTOR_MOVE_GUNK_SHOT
...
TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE,\
TUTOR_MOVE_KNOCK_OFF | TUTOR_MOVE_SIGNAL_BEAM | TUTOR_MOVE_HYDRO_PUMP
...
TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_SHOCK_WAVE | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL,\
TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_SUPERPOWER
...
TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_SHOCK_WAVE | TUTOR_MOVE_TRAILBLAZE,\
TUTOR_MOVE_PSYCHIC_FANGS | TUTOR_MOVE_SIGNAL_BEAM | TUTOR_MOVE_VOLT_SWITCH | TUTOR_MOVE_PLAY_ROUGH | TUTOR_MOVE_SUPERPOWER | TUTOR_MOVE_WILD_CHARGE
...
TUTOR_MOVE_IRON_HEAD | TUTOR_MOVE_THUNDER_PUNCH | TUTOR_MOVE_ZEN_HEADBUTT | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_EARTH_POWER | TUTOR_MOVE_OUTRAGE | TUTOR_MOVE_SUPERPOWER
...
TUTOR_MOVE_IRON_HEAD | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_EARTH_POWER | TUTOR_MOVE_HEAVY_SLAM

tutordata SPECIES_BASTIODON,\
TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_INCINERATE | TUTOR_MOVE_SHOCK_WAVE,\
TUTOR_MOVE_IRON_HEAD | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_EARTH_POWER | TUTOR_MOVE_HEAVY_SLAM | TUTOR_MOVE_OUTRAGE
...
TUTOR_MOVE_ELECTROWEB | TUTOR_MOVE_PSYBEAM,\
...
TUTOR_MOVE_CHILLING_WATER | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL,\
...
TUTOR_MOVE_DRAINING_KISS | TUTOR_MOVE_MAGICAL_LEAF,\
TUTOR_MOVE_SEED_BOMB
...
TUTOR_MOVE_AIR_CUTTER | TUTOR_MOVE_CHILLING_WATER | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_INCINERATE | TUTOR_MOVE_OMINOUS_WIND | TUTOR_MOVE_HEAT_WAVE,\
...
TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_AQUA_TAIL | TUTOR_MOVE_CROSS_POISON,\
TUTOR_MOVE_KNOCK_OFF

tutordata SPECIES_DRAPION,\
TUTOR_MOVE_BRUTAL_SWING | TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_AQUA_TAIL | TUTOR_MOVE_CROSS_POISON,\
TUTOR_MOVE_KNOCK_OFF
...
TUTOR_MOVE_AIR_CUTTER | TUTOR_MOVE_CHILLING_WATER | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_OMINOUS_WIND | TUTOR_MOVE_PSYBEAM | TUTOR_MOVE_SILVER_WIND | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL | TUTOR_MOVE_CHARM,\
TUTOR_MOVE_SIGNAL_BEAM | TUTOR_MOVE_HYDRO_PUMP
...
TUTOR_MOVE_AIR_CUTTER | TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE,\
TUTOR_MOVE_SIGNAL_BEAM | TUTOR_MOVE_HYDRO_PUMP
...
TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_BRUTAL_SWING | TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_SHOCK_WAVE,\
TUTOR_MOVE_KNOCK_OFF | TUTOR_MOVE_SEED_BOMB | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_POWER_WHIP
...
TUTOR_MOVE_HYPER_VOICE | TUTOR_MOVE_SIGNAL_BEAM | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_STORED_POWER | TUTOR_MOVE_TRIPLE_AXEL
...
TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_SHOCK_WAVE | TUTOR_MOVE_FIRE_PUNCH,\
TUTOR_MOVE_ICE_PUNCH | TUTOR_MOVE_IRON_HEAD | TUTOR_MOVE_POWER_GEM | TUTOR_MOVE_THUNDER_PUNCH | TUTOR_MOVE_VOLT_SWITCH | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_EARTH_POWER
...
TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_CHARM,\
TUTOR_MOVE_KNOCK_OFF | TUTOR_MOVE_SIGNAL_BEAM
...
TUTOR_MOVE_AIR_CUTTER | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_MAGICAL_LEAF | TUTOR_MOVE_OMINOUS_WIND,\
TUTOR_MOVE_SEED_BOMB | TUTOR_MOVE_ZEN_HEADBUTT | TUTOR_MOVE_EARTH_POWER
...
tutordata SPECIES_WORMADAM_TRASHY, TUTOR_MOVE_ELECTROWEB | TUTOR_MOVE_GYRO_BALL | TUTOR_MOVE_PSYBEAM, TUTOR_MOVE_IRON_HEAD | TUTOR_MOVE_SIGNAL_BEAM | TUTOR_MOVE_SUCKER_PUNCH | TUTOR_MOVE_GUNK_SHOT
...
TUTOR_MOVE_MAGICAL_LEAF | TUTOR_MOVE_AQUA_TAIL,\
...
TUTOR_MOVE_BRUTAL_SWING | TUTOR_MOVE_MAGICAL_LEAF | TUTOR_MOVE_AQUA_TAIL | TUTOR_MOVE_DRAGON_TAIL,\
TUTOR_MOVE_KNOCK_OFF | TUTOR_MOVE_SEED_BOMB | TUTOR_MOVE_OUTRAGE
...
TUTOR_MOVE_SUCKER_PUNCH | TUTOR_MOVE_THUNDER_PUNCH | TUTOR_MOVE_ZEN_HEADBUTT | TUTOR_MOVE_FLARE_BLITZ | TUTOR_MOVE_HEAVY_SLAM | TUTOR_MOVE_SUPERPOWER | TUTOR_MOVE_WILD_CHARGE

tutordata SPECIES_EMBOAR,\
TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_GYRO_BALL | TUTOR_MOVE_INCINERATE | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_FIRE_PUNCH | TUTOR_MOVE_HEAT_WAVE,\
TUTOR_MOVE_IRON_HEAD | TUTOR_MOVE_SUCKER_PUNCH | TUTOR_MOVE_THUNDER_PUNCH | TUTOR_MOVE_ZEN_HEADBUTT | TUTOR_MOVE_FLARE_BLITZ | TUTOR_MOVE_HEAVY_SLAM | TUTOR_MOVE_SUPERPOWER | TUTOR_MOVE_WILD_CHARGE

tutordata SPECIES_OSHAWOTT,\
TUTOR_MOVE_CHILLING_WATER | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL,\
...
TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_CHILLING_WATER | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL | TUTOR_MOVE_DRAGON_TAIL | TUTOR_MOVE_DRILL_RUN,\
TUTOR_MOVE_KNOCK_OFF | TUTOR_MOVE_HYDRO_PUMP | TUTOR_MOVE_MEGAHORN | TUTOR_MOVE_SUPERPOWER

tutordata SPECIES_PATRAT,\
TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_SHOCK_WAVE | TUTOR_MOVE_AQUA_TAIL,\
TUTOR_MOVE_SEED_BOMB | TUTOR_MOVE_ZEN_HEADBUTT | TUTOR_MOVE_GUNK_SHOT

tutordata SPECIES_WATCHOG,\
TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_SHOCK_WAVE | TUTOR_MOVE_AQUA_TAIL | TUTOR_MOVE_FIRE_PUNCH,\
...
TUTOR_MOVE_SHOCK_WAVE | TUTOR_MOVE_CHARM,\
...
TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_MAGICAL_LEAF,\
TUTOR_MOVE_KNOCK_OFF | TUTOR_MOVE_SEED_BOMB | TUTOR_MOVE_GUNK_SHOT

tutordata SPECIES_SIMISAGE,\
TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_MAGICAL_LEAF,\
TUTOR_MOVE_KNOCK_OFF | TUTOR_MOVE_SEED_BOMB | TUTOR_MOVE_GUNK_SHOT | TUTOR_MOVE_SUPERPOWER

tutordata SPECIES_PANSEAR,\
TUTOR_MOVE_INCINERATE | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_FIRE_PUNCH | TUTOR_MOVE_HEAT_WAVE,\
TUTOR_MOVE_KNOCK_OFF | TUTOR_MOVE_FLARE_BLITZ | TUTOR_MOVE_GUNK_SHOT

tutordata SPECIES_SIMISEAR,\
TUTOR_MOVE_INCINERATE | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_FIRE_PUNCH | TUTOR_MOVE_HEAT_WAVE,\
TUTOR_MOVE_KNOCK_OFF | TUTOR_MOVE_FLARE_BLITZ | TUTOR_MOVE_GUNK_SHOT | TUTOR_MOVE_SUPERPOWER

tutordata SPECIES_PANPOUR,\
TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL,\
TUTOR_MOVE_ICE_PUNCH | TUTOR_MOVE_KNOCK_OFF | TUTOR_MOVE_GUNK_SHOT | TUTOR_MOVE_HYDRO_PUMP

tutordata SPECIES_SIMIPOUR,\
TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL,\
TUTOR_MOVE_ICE_PUNCH | TUTOR_MOVE_KNOCK_OFF | TUTOR_MOVE_GUNK_SHOT | TUTOR_MOVE_HYDRO_PUMP | TUTOR_MOVE_SUPERPOWER
...
TUTOR_MOVE_AIR_CUTTER | TUTOR_MOVE_GYRO_BALL | TUTOR_MOVE_SHOCK_WAVE | TUTOR_MOVE_CHARM | TUTOR_MOVE_DUAL_WINGBEAT | TUTOR_MOVE_HEAT_WAVE,\
TUTOR_MOVE_KNOCK_OFF | TUTOR_MOVE_PSYCHIC_FANGS | TUTOR_MOVE_SIGNAL_BEAM | TUTOR_MOVE_ZEN_HEADBUTT | TUTOR_MOVE_STORED_POWER
...
TUTOR_MOVE_DRAINING_KISS | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_INCINERATE | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_FIRE_PUNCH,\
...
TUTOR_MOVE_ICE_PUNCH | TUTOR_MOVE_KNOCK_OFF | TUTOR_MOVE_THUNDER_PUNCH | TUTOR_MOVE_SUPERPOWER
...
TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE,\
TUTOR_MOVE_HYPER_VOICE | TUTOR_MOVE_EARTH_POWER | TUTOR_MOVE_HYDRO_PUMP | TUTOR_MOVE_POWER_WHIP

tutordata SPECIES_SEISMITOAD,\
TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_WATER_PULSE,\
...
TUTOR_MOVE_ELECTROWEB | TUTOR_MOVE_SILVER_WIND,\
TUTOR_MOVE_KNOCK_OFF | TUTOR_MOVE_SEED_BOMB | TUTOR_MOVE_SIGNAL_BEAM
...
TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_GYRO_BALL | TUTOR_MOVE_AQUA_TAIL | TUTOR_MOVE_CROSS_POISON,\
...
0,\
TUTOR_MOVE_HYPER_VOICE | TUTOR_MOVE_KNOCK_OFF | TUTOR_MOVE_SEED_BOMB | TUTOR_MOVE_SUCKER_PUNCH
...
TUTOR_MOVE_ICE_PUNCH | TUTOR_MOVE_IRON_HEAD | TUTOR_MOVE_KNOCK_OFF | TUTOR_MOVE_THUNDER_PUNCH | TUTOR_MOVE_ZEN_HEADBUTT | TUTOR_MOVE_FOUL_PLAY
...
TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL,\
...
TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL,\
...
TUTOR_MOVE_AIR_CUTTER | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_WATER_PULSE,\
TUTOR_MOVE_HURRICANE
...
TUTOR_MOVE_ACID_SPRAY | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_DRILL_RUN,\
TUTOR_MOVE_KNOCK_OFF | TUTOR_MOVE_SIGNAL_BEAM | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_MEGAHORN

tutordata SPECIES_ESCAVALIER,\
TUTOR_MOVE_ACID_SPRAY | TUTOR_MOVE_BRUTAL_SWING | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_DRILL_RUN,\
...
TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_OMINOUS_WIND | TUTOR_MOVE_SHOCK_WAVE | TUTOR_MOVE_WATER_PULSE,\
...
TUTOR_MOVE_ELECTROWEB | TUTOR_MOVE_SHOCK_WAVE | TUTOR_MOVE_CROSS_POISON,\
...
TUTOR_MOVE_ICE_PUNCH | TUTOR_MOVE_SIGNAL_BEAM | TUTOR_MOVE_THUNDER_PUNCH | TUTOR_MOVE_EARTH_POWER | TUTOR_MOVE_HEAVY_SLAM | TUTOR_MOVE_POLTERGEIST | TUTOR_MOVE_SUPERPOWER

tutordata SPECIES_GOLURK,\
TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_GYRO_BALL | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_SHOCK_WAVE | TUTOR_MOVE_FIRE_PUNCH,\
TUTOR_MOVE_ICE_PUNCH | TUTOR_MOVE_SIGNAL_BEAM | TUTOR_MOVE_THUNDER_PUNCH | TUTOR_MOVE_ZEN_HEADBUTT | TUTOR_MOVE_CLOSE_COMBAT | TUTOR_MOVE_EARTH_POWER | TUTOR_MOVE_HEAVY_SLAM | TUTOR_MOVE_POLTERGEIST | TUTOR_MOVE_SUPERPOWER
