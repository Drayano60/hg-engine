...
afterLeafGuardCheck:
    CheckIgnorableAbility CHECK_OPCODE_HAVE, BATTLER_CATEGORY_SIDE_EFFECT_MON, ABILITY_SWEET_VEIL, _SweetVeilMsg /**** AURORA CRYSTAL: Added Sweet Veil check */
    CheckIgnorableAbility CHECK_OPCODE_HAVE, BATTLER_RELATIVE_ALLY | BATTLER_CATEGORY_SIDE_EFFECT_MON, ABILITY_SWEET_VEIL, _SweetVeilMsg /**** AURORA CRYSTAL: Added Sweet Veil check */

    CheckIgnorableAbility CHECK_OPCODE_HAVE, BATTLER_CATEGORY_SIDE_EFFECT_MON, ABILITY_FLOWER_VEIL, checkGrassForFlowerVeil
    CheckIgnorableAbility CHECK_OPCODE_HAVE, BATTLER_RELATIVE_ALLY|BATTLER_CATEGORY_SIDE_EFFECT_MON, ABILITY_FLOWER_VEIL, checkGrassForFlowerVeil
    GoTo afterGrassChecks

checkGrassForFlowerVeil:
