...
u16 MainMusicComboTable[][2] =
{
    ...
    /**** AURORA CRYSTAL: Added more entries. */
    [ANIM_MUSIC_COMBO_CELEBI] = {34, SEQ_GS_VS_NORAPOKE},
    [ANIM_MUSIC_COMBO_REGI] = {34, VS_REGI},
    [ANIM_MUSIC_COMBO_JIRACHI] = {34, VS_HOENN_WILD},
    [ANIM_MUSIC_COMBO_DEOXYS] = {34, VS_DEOXYS},
    [ANIM_MUSIC_COMBO_LAKE_TRIO] = {34, VS_LAKE_TRIO},
    [ANIM_MUSIC_COMBO_DIALGA_PALKIA] = {34, VS_DIALGA_PALKIA},
    [ANIM_MUSIC_COMBO_SINNOH_LEGEND] = {34, VS_SINNOH_LEGENDARY},
    [ANIM_MUSIC_COMBO_GIRATINA] = {34, VS_GIRATINA},
    [ANIM_MUSIC_COMBO_MANAPHY_SHAYMIN] = {34, VS_SINNOH_WILD},
    [ANIM_MUSIC_COMBO_ARCEUS] = {34, SEQ_GS_E_ARCEUS},
    [ANIM_MUSIC_COMBO_PKMN_TRAINER_LANCE] = {36, SEQ_GS_VS_CHAMP},
    [ANIM_MUSIC_COMBO_PKMN_TRAINER_CYNTHIA] = {36, VS_CYNTHIA},
    [ANIM_MUSIC_COMBO_PKMN_TRAINER_STEVEN] = {36, VS_STEVEN},
    [ANIM_MUSIC_COMBO_PKMN_TRAINER_BLUE] = {36, VS_BLUE},
};
...
u8 TrainerClassToMusicCombo[][2] =
{
    ...
    // (***END OF VANILLA ENTRIES***)
    /**** AURORA CRYSTAL: Added more entries. */
    {TRAINERCLASS_STEVEN, ANIM_MUSIC_COMBO_PKMN_TRAINER_STEVEN*4},
    {TRAINERCLASS_CYNTHIA, ANIM_MUSIC_COMBO_PKMN_TRAINER_CYNTHIA*4},
    {TRAINERCLASS_SCIENTIST_GS, ANIM_MUSIC_COMBO_ROCKET_GRUNTS*4},
    {TRAINERCLASS_BLUE, ANIM_MUSIC_COMBO_PKMN_TRAINER_BLUE*4},
    {TRAINERCLASS_LANCE, ANIM_MUSIC_COMBO_PKMN_TRAINER_LANCE*4},
};
...
struct MonBattleMusic PokemonBattleMusic[] =
{
    ...
    // (***END VANILLA ENTRIES***)
    /**** AURORA CRYSTAL: More entries. */
    {.species = SPECIES_ARTICUNO, .combo = ANIM_MUSIC_COMBO_MEWTWO_LATI_TWINS},
    {.species = SPECIES_ZAPDOS, .combo = ANIM_MUSIC_COMBO_MEWTWO_LATI_TWINS},
    {.species = SPECIES_MOLTRES, .combo = ANIM_MUSIC_COMBO_MEWTWO_LATI_TWINS},
    {.species = SPECIES_MEW, .combo = ANIM_MUSIC_COMBO_MEWTWO_LATI_TWINS},
    {.species = SPECIES_CELEBI, .combo = ANIM_MUSIC_COMBO_CELEBI},
    {.species = SPECIES_REGIROCK, .combo = ANIM_MUSIC_COMBO_REGI},
    {.species = SPECIES_REGICE, .combo = ANIM_MUSIC_COMBO_REGI},
    {.species = SPECIES_REGISTEEL, .combo = ANIM_MUSIC_COMBO_REGI},
    {.species = SPECIES_JIRACHI, .combo = ANIM_MUSIC_COMBO_JIRACHI},
    {.species = SPECIES_DEOXYS, .combo = ANIM_MUSIC_COMBO_DEOXYS},
    {.species = SPECIES_UXIE, .combo = ANIM_MUSIC_COMBO_LAKE_TRIO},
    {.species = SPECIES_MESPRIT, .combo = ANIM_MUSIC_COMBO_LAKE_TRIO},
    {.species = SPECIES_AZELF, .combo = ANIM_MUSIC_COMBO_LAKE_TRIO},
    {.species = SPECIES_DIALGA, .combo = ANIM_MUSIC_COMBO_DIALGA_PALKIA},
    {.species = SPECIES_PALKIA, .combo = ANIM_MUSIC_COMBO_DIALGA_PALKIA},
    {.species = SPECIES_HEATRAN, .combo = ANIM_MUSIC_COMBO_SINNOH_LEGEND},
    {.species = SPECIES_REGIGIGAS, .combo = ANIM_MUSIC_COMBO_REGI},
    {.species = SPECIES_GIRATINA, .combo = ANIM_MUSIC_COMBO_GIRATINA},
    {.species = SPECIES_CRESSELIA, .combo = ANIM_MUSIC_COMBO_SINNOH_LEGEND},
    {.species = SPECIES_PHIONE, .combo = ANIM_MUSIC_COMBO_MANAPHY_SHAYMIN},
    {.species = SPECIES_MANAPHY, .combo = ANIM_MUSIC_COMBO_MANAPHY_SHAYMIN},
    {.species = SPECIES_DARKRAI, .combo = ANIM_MUSIC_COMBO_SINNOH_LEGEND},
    {.species = SPECIES_SHAYMIN, .combo = ANIM_MUSIC_COMBO_MANAPHY_SHAYMIN},
    {.species = SPECIES_ARCEUS, .combo = ANIM_MUSIC_COMBO_ARCEUS},
    {.species = SPECIES_VICTINI, .combo = ANIM_MUSIC_COMBO_SINNOH_LEGEND},
    {.species = SPECIES_DIANCIE, .combo = ANIM_MUSIC_COMBO_SINNOH_LEGEND},
};
