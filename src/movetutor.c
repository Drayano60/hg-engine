...
struct MoveTutor MoveTutorTable[] = {
    ...
    // Bonus Moves
    {.move = MOVE_CHILLING_WATER, .cost = 0, .tutor = TUTOR_EARLY},
    {.move = MOVE_ELECTROWEB, .cost = 0, .tutor = TUTOR_EARLY},
    {.move = MOVE_POUNCE, .cost = 0, .tutor = TUTOR_EARLY},
    {.move = MOVE_TRAILBLAZE, .cost = 0, .tutor = TUTOR_EARLY},
    ...
    // Bonus Moves
    {.move = MOVE_FLIP_TURN, .cost = 0, .tutor = TUTOR_MIDDLE},
    {.move = MOVE_HEAT_WAVE, .cost = 0, .tutor = TUTOR_MIDDLE},
    {.move = MOVE_PSYCHIC_FANGS, .cost = 0, .tutor = TUTOR_MIDDLE},
    {.move = MOVE_SUCKER_PUNCH, .cost = 0, .tutor = TUTOR_MIDDLE},
    {.move = MOVE_VOLT_SWITCH, .cost = 0, .tutor = TUTOR_MIDDLE},
    ...
    // Bonus Moves
    {.move = MOVE_SUPERPOWER, .cost = 0, .tutor = TUTOR_LATE},
};
