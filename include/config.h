...
#define CRY_PSEUDOBANK_START 788 // Pushed ahead from 778
...
#define GIVE_EGG_OVERRIDE 2602
#define GUARANTEED_CATCH_FLAG 2603
#define TIMES_GIFT_FLAG 2631
