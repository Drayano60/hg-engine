...
struct __attribute__((packed)) OneTurnEffect
{
    /* 0x00 */ u32 struggle_flag : 1;     /**< pokémon struggled this turn */
               ...
               /**** AURORA CRYSTAL: Added a new flag for moves with effects on stat increase. ****/
               u32 stats_raised_flag : 1;
               ...
               /**** AURORA CRYSTAL: Changed from 20 -> 19 due to extra flag. ****/
               u32 : 19;
...
struct __attribute__((packed)) BattlePokemon
{
    ...
    /* 0x28 */ u32 appear_check_flag : 1;    /**< has appeared */
               ...
               u32 glaive_rush_flag : 1; /**** AURORA CRYSTAL: Added Glaive Rush flag, changed remaining to 5. */
