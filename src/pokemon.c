...
static const u16 sSpeciesToOWGfx[] =
{
    ...
    [SPECIES_POLTCHAGEIST       ] = 1294,
    [SPECIES_SINISTCHA          ] = 1295,
    [SPECIES_OKIDOGI            ] = 1296,
    [SPECIES_MUNKIDORI          ] = 1297,
    [SPECIES_FEZANDIPITI        ] = 1298,
    [SPECIES_OGERPON            ] = 1299,
    [SPECIES_ARCHALUDON         ] = 1300,
    [SPECIES_HYDRAPPLE          ] = 1301,
    [SPECIES_GOUGING_FIRE       ] = 1302,
    [SPECIES_RAGING_BOLT        ] = 1303,
    [SPECIES_IRON_BOULDER       ] = 1304,
    [SPECIES_IRON_CROWN         ] = 1305,
    [SPECIES_TERAPAGOS          ] = 1306,
    [SPECIES_PECHARUNT          ] = 1307,
};
...
void LONG_CALL SetBoxMonAbility(struct BoxPokemon *boxmon) // actually takes boxmon struct as parameter, but that doesn't need to be properly defined yet
{
    ...
    SetBoxMonData(boxmon, MON_DATA_RESERVED_113, (u8 *)&has_hidden_ability);
