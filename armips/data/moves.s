...
/* These are here to fill in the gaps with moves that don't have a description defined yet, as otherwise the strings get misaligned.
The move's actual description is filled in later. */
movedescription 0, "\n\n\n\n"
movedescription 1, "\n\n\n\n"
movedescription 2, "\n\n\n\n"
movedescription 3, "\n\n\n\n"
...
movedata MOVE_SLAM, "Slam"
    ...
    basepower 80
    type TYPE_NORMAL
    accuracy MOVE_CHANGES_IMPLEMENTED ? 100 : 75
    pp 20
    effectchance 0
    target MOVE_TARGET_SELECTED
    priority 0
...
// ACCURACY: 90 >> 85 (Compensation for the 10% STAB bonus)
...
movedatalongname MOVE_PARABOLIC_CHARGE, "Parabolic C.", "Parabolic Charge"
    battleeffect 3
    pss SPLIT_SPECIAL
    basepower 65
    type TYPE_ELECTRIC
...
movedata MOVE_PRECIPICE_BLADES, "PrecipiceBlades"
    battleeffect 0
    pss SPLIT_PHYSICAL
    basepower 120
    type TYPE_GROUND
...
movedatalongname MOVE_BURNING_JEALOUSY, "B. Jealousy", "Burning Jealousy"
    battleeffect 334
    pss SPLIT_SPECIAL
    basepower 70
    type TYPE_FIRE
...
movedatalongname MOVE_CHILLY_RECEPTION, "C. Reception", "Chilly Reception"
