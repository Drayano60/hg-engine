...
/**** AURORA CRYSTAL: Additional Evolution Methods ****/
...
/**** AURORA CRYSTAL: Modified Trainer Class Definitions ****/
CLASS_CHERYL equ 90
CLASS_RILEY equ 91
CLASS_MARLEY equ 92
CLASS_BUCK equ 93
...
/**** AURORA CRYSTAL: Tutor Move Definitions ****/
TUTOR_MOVE_ACID_SPRAY equ 1 << 0
TUTOR_MOVE_AIR_CUTTER equ 1 << 1
TUTOR_MOVE_ANCIENT_POWER equ 1 << 2
TUTOR_MOVE_BREAKING_SWIPE equ 1 << 3
TUTOR_MOVE_BRUTAL_SWING equ 1 << 4
TUTOR_MOVE_BULLDOZE equ 1 << 5
TUTOR_MOVE_CHILLING_WATER equ 1 << 6
TUTOR_MOVE_DRAINING_KISS equ 1 << 7
TUTOR_MOVE_ELECTROWEB equ 1 << 8
TUTOR_MOVE_GYRO_BALL equ 1 << 9
TUTOR_MOVE_HEADBUTT equ 1 << 10
TUTOR_MOVE_ICY_WIND equ 1 << 11
TUTOR_MOVE_INCINERATE equ 1 << 12
TUTOR_MOVE_LOW_KICK equ 1 << 13
TUTOR_MOVE_MAGICAL_LEAF equ 1 << 14
TUTOR_MOVE_OMINOUS_WIND equ 1 << 15
TUTOR_MOVE_POUNCE equ 1 << 16
TUTOR_MOVE_PSYBEAM equ 1 << 17
TUTOR_MOVE_SHOCK_WAVE equ 1 << 18
TUTOR_MOVE_SILVER_WIND equ 1 << 19
TUTOR_MOVE_TRAILBLAZE equ 1 << 20
TUTOR_MOVE_WATER_PULSE equ 1 << 21
TUTOR_MOVE_ALLURING_VOICE equ 1 << 22
TUTOR_MOVE_AQUA_TAIL equ 1 << 23
TUTOR_MOVE_AURA_SPHERE equ 1 << 24
TUTOR_MOVE_BURNING_JEALOUSY equ 1 << 25
TUTOR_MOVE_CROSS_POISON equ 1 << 26
TUTOR_MOVE_DRAGON_TAIL equ 1 << 27
TUTOR_MOVE_DRILL_RUN equ 1 << 28
TUTOR_MOVE_DUAL_WINGBEAT equ 1 << 29
TUTOR_MOVE_FLIP_TURN equ 1 << 30
TUTOR_MOVE_HEAT_WAVE equ 1 << 31

TUTOR_MOVE_HEX equ 1 << 0
TUTOR_MOVE_HYPER_VOICE equ 1 << 1
TUTOR_MOVE_ICE_SPINNER equ 1 << 2
TUTOR_MOVE_IRON_HEAD equ 1 << 3
TUTOR_MOVE_KNOCK_OFF equ 1 << 4
TUTOR_MOVE_POWER_GEM equ 1 << 5
TUTOR_MOVE_PSYCHIC_FANGS equ 1 << 6
TUTOR_MOVE_SEED_BOMB equ 1 << 7
TUTOR_MOVE_SIGNAL_BEAM equ 1 << 8
TUTOR_MOVE_SUCKER_PUNCH equ 1 << 9
TUTOR_MOVE_SUPERCELL_SLAM equ 1 << 10
TUTOR_MOVE_VOLT_SWITCH equ 1 << 11
TUTOR_MOVE_ZEN_HEADBUTT equ 1 << 12
TUTOR_MOVE_CLOSE_COMBAT equ 1 << 13
TUTOR_MOVE_EARTH_POWER equ 1 << 14
TUTOR_MOVE_FLARE_BLITZ equ 1 << 15
TUTOR_MOVE_FOUL_PLAY equ 1 << 16
TUTOR_MOVE_GUNK_SHOT equ 1 << 17
TUTOR_MOVE_HEAVY_SLAM equ 1 << 18
TUTOR_MOVE_HURRICANE equ 1 << 19
TUTOR_MOVE_HYDRO_PUMP equ 1 << 20
TUTOR_MOVE_MEGAHORN equ 1 << 21
TUTOR_MOVE_METEOR_BEAM equ 1 << 22
TUTOR_MOVE_OUTRAGE equ 1 << 23
TUTOR_MOVE_PLAY_ROUGH equ 1 << 24
TUTOR_MOVE_POLTERGEIST equ 1 << 25
TUTOR_MOVE_POWER_WHIP equ 1 << 26
TUTOR_MOVE_STORED_POWER equ 1 << 27
TUTOR_MOVE_SUPERPOWER equ 1 << 28
TUTOR_MOVE_SUPER_FANG equ 1 << 29
TUTOR_MOVE_TRIPLE_AXEL equ 1 << 30
TUTOR_MOVE_WILD_CHARGE equ 1 << 31
