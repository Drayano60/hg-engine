...
/* sub_seq added + duplicated from Snow Warning so we can retain the original message */

.create "build/move/battle_sub_seq/1_492", 0x0

a001_492:
    if IF_MASK, VAR_FIELD_EFFECT, WEATHER_HAIL, _0094
    printmessage 2114, TAG_NICK_ABILITY, BATTLER_WORK, BATTLER_x15, "NaN", "NaN", "NaN", "NaN"
    waitmessage
    wait 0x1E
