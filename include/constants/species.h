...
//mega
#define SPECIES_MEGA_START (MAX_MON_NUM+1) // 956
...
#define SPECIES_SIGNIFICANT_GENDER_DIFFERENCE_START (MAX_HISUIAN_REGIONAL_NUM + 1) // 1208
...
#define MAX_SPECIES_INCLUDING_FORMS (MAX_SPECIES_SIGNIFICANT_GENDER_DIFFERENCE_NUM)
