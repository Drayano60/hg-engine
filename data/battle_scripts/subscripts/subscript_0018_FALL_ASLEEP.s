...
_000:
    ...
    CheckAbility CHECK_OPCODE_HAVE, BATTLER_CATEGORY_SIDE_EFFECT_MON, ABILITY_SWEET_VEIL, _237 /**** AURORA CRYSTAL: Added Sweet Veil check */
    CheckAbility CHECK_OPCODE_HAVE, BATTLER_RELATIVE_ALLY | BATTLER_CATEGORY_SIDE_EFFECT_MON, ABILITY_SWEET_VEIL, _237 /**** AURORA CRYSTAL: Added Sweet Veil check */
...
_055:
    ...
    CheckIgnorableAbility CHECK_OPCODE_HAVE, BATTLER_CATEGORY_SIDE_EFFECT_MON, ABILITY_SWEET_VEIL, _237 /**** AURORA CRYSTAL: Added Sweet Veil check */
    CheckIgnorableAbility CHECK_OPCODE_HAVE, BATTLER_RELATIVE_ALLY | BATTLER_CATEGORY_SIDE_EFFECT_MON, ABILITY_SWEET_VEIL, _237 /**** AURORA CRYSTAL: Added Sweet Veil check */
...
_089:
    CompareMonDataToValue OPCODE_EQU, BATTLER_CATEGORY_SIDE_EFFECT_MON, BMON_DATA_TYPE_1, TYPE_GRASS, _373
    CompareMonDataToValue OPCODE_EQU, BATTLER_CATEGORY_SIDE_EFFECT_MON, BMON_DATA_TYPE_2, TYPE_GRASS, _373
...
_112:
    ...
    CompareMonDataToValue OPCODE_EQU, BATTLER_CATEGORY_SIDE_EFFECT_MON, BMON_DATA_HELD_ITEM, ITEM_COVERT_CLOAK, _272 /**** AURORA CRYSTAL: Added Covert Cloak check ****/
_122:
...
_237:
    ...
    CompareVarToValue OPCODE_EQU, BSCRIPT_VAR_SIDE_EFFECT_TYPE, SIDE_EFFECT_TYPE_MOVE_EFFECT, _256
    PrintAttackMessage
    Wait
    WaitButtonABTime 30

_256:
    CheckAbility CHECK_OPCODE_HAVE, BATTLER_CATEGORY_SIDE_EFFECT_MON, ABILITY_SWEET_VEIL, _SweetVeilMsg /**** AURORA CRYSTAL: Added Sweet Veil check */
    CheckAbility CHECK_OPCODE_HAVE, BATTLER_RELATIVE_ALLY | BATTLER_CATEGORY_SIDE_EFFECT_MON, ABILITY_SWEET_VEIL, _SweetVeilMsg /**** AURORA CRYSTAL: Added Sweet Veil check */
...
_SweetVeilMsg:
    PrintMessage 2000, TAG_NICKNAME_ABILITY, BATTLER_CATEGORY_SIDE_EFFECT_MON, BATTLER_CATEGORY_SIDE_EFFECT_MON
    goto _365
