...
#define ITEM_HEAVY_DUTY_BOOTS (ITEM_MEGA_STONES_START + 58)
#define ITEM_COVER_FOSSIL (ITEM_MEGA_STONES_START + 59)
#define ITEM_PLUME_FOSSIL (ITEM_MEGA_STONES_START + 60)

#define ITEM_JAW_FOSSIL (ITEM_MEGA_STONES_START + 61)
#define ITEM_SAIL_FOSSIL (ITEM_MEGA_STONES_START + 62)
#define ITEM_WHIPPED_DREAM (ITEM_MEGA_STONES_START + 63)
#define ITEM_SACHET (ITEM_MEGA_STONES_START + 64)

#define ITEM_BUFFER (ITEM_MEGA_STONES_START + 65)

#define NUM_MEGA_STONES 47 + 20 // includes the pixie plate
...
#define NEW_ITEM_MAX ITEM_BUFFER
...
#define ITEM_BURN_DRIVE ITEM_FIRE_STONE
#define ITEM_CHILL_DRIVE ITEM_MOON_STONE
#define ITEM_DOUSE_DRIVE ITEM_WATER_STONE

#define ITEM_REVEAL_MIRROR ITEM_GRACIDEA
#define ITEM_DNA_SPLICERS ITEM_GRACIDEA
