...
u16 move_effect_to_subscripts[] =
{
    ...
    /**** AURORA CRYSTAL: Table padding + additional effects ****/
    ...
    [199]                                        = 0,
    [200]                                        = 0,
    [ADD_STATUS_AURORA_VEIL]                     = SUB_SEQ_AURORA_VEIL,
    [ADD_STATUS_CHILLY_RECEPTION]                = SUB_SEQ_CHILLY_RECEPTION,
    [ADD_STATUS_CLEAR_SMOG]                      = SUB_SEQ_CLEAR_SMOG,
    [ADD_STATUS_FINAL_GAMBIT]                    = SUB_SEQ_FINAL_GAMBIT,
    [ADD_STATUS_INCINERATE]                      = SUB_SEQ_INCINERATE,
    [ADD_STATUS_NOBLE_ROAR]                      = SUB_SEQ_ATK_AND_SPATK_DOWN,
    [ADD_STATUS_PARTING_SHOT]                    = SUB_SEQ_PARTING_SHOT,
    [ADD_STATUS_POLLEN_PUFF_HEAL]                = SUB_SEQ_POLLEN_PUFF_HEAL,
    [ADD_STATUS_SCALE_SHOT]                      = SUB_SEQ_SCALE_SHOT,
    [ADD_STATUS_HALF_MAX_HP_RECOIL]              = SUB_SEQ_HALF_MAX_HP_RECOIL,
    [ADD_STATUS_STRENGTH_SAP]                    = SUB_SEQ_STRENGTH_SAP,
    [ADD_STATUS_TOXIC_THREAD]                    = SUB_SEQ_TOXIC_THREAD,
    [ADD_STATUS_TRIPLE_ARROWS]                   = SUB_SEQ_TRIPLE_ARROWS,
    [ADD_STATUS_COTTON_GUARD]                    = SUB_SEQ_COTTON_GUARD,
