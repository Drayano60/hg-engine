...
// NEW: Breaking Swipe, Power Whip
tutordata SPECIES_EKANS,\
TUTOR_MOVE_ACID_SPRAY | TUTOR_MOVE_BRUTAL_SWING | TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_AQUA_TAIL | TUTOR_MOVE_BREAKING_SWIPE,\
...
// NEW: Trailblaze, Draining Kiss, Play Rough
...
TUTOR_MOVE_SEED_BOMB | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_OUTRAGE | TUTOR_MOVE_POWER_WHIP | TUTOR_MOVE_EARTH_POWER | TUTOR_MOVE_PLAY_ROUGH
...
// NEW: Chilling Water, Flip Turn
tutordata SPECIES_TOTODILE,\
TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_ICY_WIND | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_AQUA_TAIL | TUTOR_MOVE_CHILLING_WATER | TUTOR_MOVE_FLIP_TURN,\
...
TUTOR_MOVE_SEED_BOMB | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_PLAY_ROUGH | TUTOR_MOVE_EARTH_POWER
...
TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_AQUA_TAIL | TUTOR_MOVE_CROSS_POISON,\
...
// NEW: Double-Edge (PLA), Dual Wingbeat, Iron Head
...
TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_HEADBUTT | TUTOR_MOVE_INCINERATE | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_FIRE_PUNCH | TUTOR_MOVE_HEAT_WAVE,\
TUTOR_MOVE_THUNDER_PUNCH | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_FLARE_BLITZ
...
TUTOR_MOVE_KNOCK_OFF | TUTOR_MOVE_SIGNAL_BEAM | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_HYDRO_PUMP | TUTOR_MOVE_ZEN_HEADBUTT | TUTOR_MOVE_STORED_POWER
...
// NEW: Breaking Swipe, Double-Edge, Power Whip, Trailblaze
...
// NEW: Double-Edge, Close Combat, Earth Power
...
TUTOR_MOVE_SUCKER_PUNCH | TUTOR_MOVE_THUNDER_PUNCH | TUTOR_MOVE_ZEN_HEADBUTT | TUTOR_MOVE_FLARE_BLITZ | TUTOR_MOVE_HEAVY_SLAM | TUTOR_MOVE_SUPERPOWER | TUTOR_MOVE_WILD_CHARGE | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_CLOSE_COMBAT | TUTOR_MOVE_EARTH_POWER

// NEW: Double-Edge, Close Combat
.if TYPE_CHANGES_IMPLEMENTED
/* Add Earth Power */  
tutordata SPECIES_EMBOAR,\
TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_GYRO_BALL | TUTOR_MOVE_INCINERATE | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_FIRE_PUNCH | TUTOR_MOVE_HEAT_WAVE,\
TUTOR_MOVE_IRON_HEAD | TUTOR_MOVE_SUCKER_PUNCH | TUTOR_MOVE_THUNDER_PUNCH | TUTOR_MOVE_ZEN_HEADBUTT | TUTOR_MOVE_FLARE_BLITZ | TUTOR_MOVE_HEAVY_SLAM | TUTOR_MOVE_SUPERPOWER | TUTOR_MOVE_WILD_CHARGE | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_CLOSE_COMBAT | TUTOR_MOVE_EARTH_POWER
.else
tutordata SPECIES_EMBOAR,\
TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_GYRO_BALL | TUTOR_MOVE_INCINERATE | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_FIRE_PUNCH | TUTOR_MOVE_HEAT_WAVE,\
TUTOR_MOVE_IRON_HEAD | TUTOR_MOVE_SUCKER_PUNCH | TUTOR_MOVE_THUNDER_PUNCH | TUTOR_MOVE_ZEN_HEADBUTT | TUTOR_MOVE_FLARE_BLITZ | TUTOR_MOVE_HEAVY_SLAM | TUTOR_MOVE_SUPERPOWER | TUTOR_MOVE_WILD_CHARGE | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_CLOSE_COMBAT
.endif
...
// NEW: Double-Edge, Dual Wingbeat (HOME, not in SV)
...
TUTOR_MOVE_SIGNAL_BEAM | TUTOR_MOVE_SUCKER_PUNCH | TUTOR_MOVE_ZEN_HEADBUTT | TUTOR_MOVE_PLAY_ROUGH | TUTOR_MOVE_DOUBLE_EDGE | 0

// NEW: Double-Edge
tutordata SPECIES_MEOWSTIC_FEMALE,\
TUTOR_MOVE_MAGICAL_LEAF | TUTOR_MOVE_PSYBEAM | TUTOR_MOVE_SHOCK_WAVE | TUTOR_MOVE_CHARM | 0,\
...
TUTOR_MOVE_BRUTAL_SWING | TUTOR_MOVE_PSYBEAM | 0,\
...
TUTOR_MOVE_AIR_CUTTER | TUTOR_MOVE_WATER_PULSE | TUTOR_MOVE_DRAGON_TAIL | TUTOR_MOVE_DUAL_WINGBEAT | TUTOR_MOVE_HEAT_WAVE | 0,\
TUTOR_MOVE_HYPER_VOICE | TUTOR_MOVE_HURRICANE | TUTOR_MOVE_OUTRAGE | TUTOR_MOVE_WILD_CHARGE | TUTOR_MOVE_DOUBLE_EDGE | 0
...
TUTOR_MOVE_BRUTAL_SWING | TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_ELECTROWEB | TUTOR_MOVE_GYRO_BALL | TUTOR_MOVE_SHOCK_WAVE | TUTOR_MOVE_FIRE_PUNCH,\
TUTOR_MOVE_IRON_HEAD | TUTOR_MOVE_THUNDER_PUNCH | TUTOR_MOVE_VOLT_SWITCH | TUTOR_MOVE_DOUBLE_EDGE | TUTOR_MOVE_EARTH_POWER | TUTOR_MOVE_HEAVY_SLAM | TUTOR_MOVE_SUPERPOWER | TUTOR_MOVE_WILD_CHARGE
...
TUTOR_MOVE_BREAKING_SWIPE | TUTOR_MOVE_BRUTAL_SWING | TUTOR_MOVE_BULLDOZE | TUTOR_MOVE_LOW_KICK | TUTOR_MOVE_MAGICAL_LEAF | TUTOR_MOVE_DRAGON_TAIL | TUTOR_MOVE_ANCIENT_POWER | TUTOR_MOVE_HEADBUTT,\
TUTOR_MOVE_IRON_HEAD | TUTOR_MOVE_KNOCK_OFF | TUTOR_MOVE_SEED_BOMB | TUTOR_MOVE_ZEN_HEADBUTT | TUTOR_MOVE_OUTRAGE | TUTOR_MOVE_POWER_WHIP | TUTOR_MOVE_SUPERPOWER | TUTOR_MOVE_DOUBLE_EDGE
...
TUTOR_MOVE_ZEN_HEADBUTT | TUTOR_MOVE_FOUL_PLAY | TUTOR_MOVE_HYDRO_PUMP | TUTOR_MOVE_STORED_POWER | TUTOR_MOVE_DOUBLE_EDGE
...
TUTOR_MOVE_HEX | TUTOR_MOVE_ICE_PUNCH | TUTOR_MOVE_POWER_GEM | TUTOR_MOVE_THUNDER_PUNCH | TUTOR_MOVE_ZEN_HEADBUTT | TUTOR_MOVE_FOUL_PLAY | TUTOR_MOVE_GUNK_SHOT | TUTOR_MOVE_HYDRO_PUMP | TUTOR_MOVE_STORED_POWER | TUTOR_MOVE_DOUBLE_EDGE
