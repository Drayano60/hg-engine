...
#define SUB_SEQ_441                                   (441)
#define SUB_SEQ_442                                   (442)
#define SUB_SEQ_443                                   (443)
#define SUB_SEQ_TOXIC_THREAD                          (444)
#define SUB_SEQ_445                                   (445)
#define SUB_SEQ_446                                   (446)
#define SUB_SEQ_HANDLE_AIR_LOCK_MESSAGE               (447)
#define SUB_SEQ_CLEAR_SMOG                            (448)
#define SUB_SEQ_449                                   (449)
#define SUB_SEQ_450                                   (450)
#define SUB_SEQ_FINAL_GAMBIT                          (451)
#define SUB_SEQ_HANDLE_SUNNY_MOOD                     (452)
#define SUB_SEQ_HANDLE_COTTON_DOWN                    (453)
#define SUB_SEQ_454                                   (454)
#define SUB_SEQ_455                                   (455)
...
#define SUB_SEQ_460                                   (460)
#define SUB_SEQ_461                                   (461)
#define SUB_SEQ_TAIL_GLOW                             (462)
#define SUB_SEQ_COTTON_GUARD                          (463)
#define SUB_SEQ_PARTING_SHOT                          (464)
#define SUB_SEQ_HANDLE_BUFF_ON_KO                     (465)
#define SUB_SEQ_466                                   (466)
...
/**** AURORA CRYSTAL: Additional move status effects. */

#define ADD_STATUS_AURORA_VEIL                         (201)
#define ADD_STATUS_CHILLY_RECEPTION                    (202)
#define ADD_STATUS_CLEAR_SMOG                          (203)
#define ADD_STATUS_FINAL_GAMBIT                        (204)
#define ADD_STATUS_INCINERATE                          (205)
#define ADD_STATUS_NOBLE_ROAR                          (206)
#define ADD_STATUS_PARTING_SHOT                        (207)
#define ADD_STATUS_POLLEN_PUFF_HEAL                    (208)
#define ADD_STATUS_SCALE_SHOT                          (209)
#define ADD_STATUS_HALF_MAX_HP_RECOIL                  (210)
#define ADD_STATUS_STRENGTH_SAP                        (211)
#define ADD_STATUS_TOXIC_THREAD                        (212)
#define ADD_STATUS_TRIPLE_ARROWS                       (213)
