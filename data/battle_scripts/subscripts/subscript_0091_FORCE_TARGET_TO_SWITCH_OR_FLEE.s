...
_000:
    ...
    CheckIgnorableAbility CHECK_OPCODE_HAVE, BATTLER_CATEGORY_DEFENDER, ABILITY_GUARD_DOG, _102 /**** AURORA CRYSTAL: Add Guard Dog. */
...
_055:
    ...
    GoTo _ZeroToHero /**** AURORA CRYSTAL: Added Zero to Hero here. Not using subscript as BATTLER_CATEGORY_SWITCHED_MON isn't correct at this point. */

_ReturnAfterZeroToHero:
...
_ZeroToHero:
    CheckAbility CHECK_OPCODE_NOT_HAVE, BATTLER_CATEGORY_DEFENDER, ABILITY_ZERO_TO_HERO, _ReturnAfterZeroToHero
    CompareMonDataToValue OPCODE_NEQ, BATTLER_CATEGORY_DEFENDER, BMON_DATA_FORM, 0, _ReturnAfterZeroToHero
    UpdateVar OPCODE_FLAG_ON, BSCRIPT_VAR_BATTLE_STATUS_2, BATTLE_STATUS2_RECALC_MON_STATS
    UpdateMonData OPCODE_SET, BATTLER_CATEGORY_DEFENDER, BMON_DATA_FORM, 1
    GoTo _ReturnAfterZeroToHero
