...
/* sub_seq added + duplicated from Drizzle so we can retain the original message */

.create "build/move/battle_sub_seq/1_490", 0x0

a001_490:
    if IF_MASK, VAR_FIELD_EFFECT, WEATHER_RAIN_ANY, _0094
    printmessage 2108, TAG_NICK_ABILITY, BATTLER_WORK, BATTLER_x15, "NaN", "NaN", "NaN", "NaN"
    waitmessage
    wait 0x1E
