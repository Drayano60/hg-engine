...
#define MOVE_PSYSHOCK 472
#define MOVE_VENOSHOCK 473
#define MOVE_STORM_THROW 474
#define MOVE_SLUDGE_WAVE 475
#define MOVE_QUIVER_DANCE 476
#define MOVE_HEAVY_SLAM 477
#define MOVE_FLAME_CHARGE 478
#define MOVE_COIL 479
#define MOVE_LOW_SWEEP 480
#define MOVE_ACID_SPRAY 481
#define MOVE_FOUL_PLAY 482
#define MOVE_ECHOED_VOICE 483
#define MOVE_SCALD 484
#define MOVE_SHELL_SMASH 485
#define MOVE_HEX 486
#define MOVE_INCINERATE 487
#define MOVE_ACROBATICS 488
#define MOVE_INFERNO 489
#define MOVE_VOLT_SWITCH 490
#define MOVE_STRUGGLE_BUG 491
#define MOVE_BULLDOZE 492
#define MOVE_FROST_BREATH 493
#define MOVE_DRAGON_TAIL 494
#define MOVE_WORK_UP 495
#define MOVE_ELECTROWEB 496
#define MOVE_WILD_CHARGE 497
#define MOVE_DRILL_RUN 498
#define MOVE_DUAL_CHOP 499
#define MOVE_SACRED_SWORD 500
#define MOVE_RAZOR_SHELL 501
#define MOVE_COTTON_GUARD 502
#define MOVE_TAIL_SLAP 503
#define MOVE_HURRICANE 504
#define MOVE_SNARL 505
#define MOVE_ICICLE_CRASH 506
#define MOVE_PHANTOM_FORCE 507
#define MOVE_NOBLE_ROAR 508
#define MOVE_PETAL_BLIZZARD 509
#define MOVE_FREEZE_DRY 510
#define MOVE_DISARMING_VOICE 511
#define MOVE_DRAINING_KISS 512
#define MOVE_PLAY_ROUGH 513
#define MOVE_FAIRY_WIND 514
#define MOVE_MOONBLAST 515
#define MOVE_BOOMBURST 516
#define MOVE_MYSTICAL_FIRE 517
#define MOVE_EERIE_IMPULSE 518
#define MOVE_DAZZLING_GLEAM 519
#define MOVE_BABY_DOLL_EYES 520
#define MOVE_NUZZLE 521
#define MOVE_POWER_UP_PUNCH 522
#define MOVE_FIRST_IMPRESSION 523
#define MOVE_HIGH_HORSEPOWER 524
#define MOVE_SOLAR_BLADE 525
#define MOVE_LEAFAGE 526
#define MOVE_POLLEN_PUFF 527
#define MOVE_LUNGE 528
#define MOVE_SMART_STRIKE 529
#define MOVE_BRUTAL_SWING 530
#define MOVE_AURORA_VEIL 531
#define MOVE_PSYCHIC_FANGS 532
#define MOVE_LIQUIDATION 533
#define MOVE_BODY_PRESS 534
#define MOVE_BREAKING_SWIPE 535
#define MOVE_SPIRIT_BREAK 536
#define MOVE_STEEL_BEAM 537
#define MOVE_SCALE_SHOT 538
#define MOVE_METEOR_BEAM 539
#define MOVE_SKITTER_SMACK 540
#define MOVE_FLIP_TURN 541
#define MOVE_TRIPLE_AXEL 542
#define MOVE_DUAL_WINGBEAT 543
#define MOVE_SCORCHING_SANDS 544
#define MOVE_PSYSHIELD_BASH 545
#define MOVE_STONE_AXE 546
#define MOVE_RAGING_FURY 547
#define MOVE_WAVE_CRASH 548
#define MOVE_HEADLONG_RUSH 549
#define MOVE_BARB_BARRAGE 550
#define MOVE_ESPER_WING 551
#define MOVE_ICE_SPINNER 552
#define MOVE_RAGING_BULL 553
#define MOVE_TRAILBLAZE 554
#define MOVE_CHILLING_WATER 555
#define MOVE_HYPER_DRILL 556
#define MOVE_TWIN_BEAM 557
#define MOVE_RAGE_FIST 558
#define MOVE_AQUA_CUTTER 559
#define MOVE_SOOTHING_AROMA 560
#define MOVE_INFERNAL_BLAST 561
#define MOVE_SAVAGE_REND 562
#define MOVE_PIDDLY_PUNCHES 563
#define MOVE_TOXIC_THREAD 564
#define MOVE_TEARFUL_LOOK 565
#define MOVE_COMEUPPANCE 566
#define MOVE_STEAMROLLER 567
#define MOVE_DRAGON_HAMMER 568
#define MOVE_PLAY_NICE 569
#define MOVE_CONFIDE 570
#define MOVE_SHADOW_BONE 571
#define MOVE_POUNCE 572
#define MOVE_SPLASH_CRASH 573
#define MOVE_HEAT_CRASH 574
#define MOVE_DARKEST_LARIAT 575

#define MOVE_HIDDEN_POWER_POISON 576
#define MOVE_HIDDEN_POWER_GROUND 577
#define MOVE_HIDDEN_POWER_ROCK 578
#define MOVE_HIDDEN_POWER_BUG 579
#define MOVE_HIDDEN_POWER_GHOST 580
#define MOVE_HIDDEN_POWER_STEEL 581
#define MOVE_HIDDEN_POWER_FIRE 582
#define MOVE_HIDDEN_POWER_WATER 583
#define MOVE_HIDDEN_POWER_GRASS 584
#define MOVE_HIDDEN_POWER_ELECTRIC 585
#define MOVE_HIDDEN_POWER_PSYCHIC 586
#define MOVE_HIDDEN_POWER_ICE 587
#define MOVE_HIDDEN_POWER_DRAGON 588
#define MOVE_HIDDEN_POWER_DARK 589
#define MOVE_HIDDEN_POWER_FIGHTING 590
#define MOVE_HIDDEN_POWER_FLYING 591

#define NUM_OF_MOVES 591

#define MOVE_WIDE_GUARD 999
#define MOVE_GUARD_SPLIT 999
#define MOVE_POWER_SPLIT 999
#define MOVE_WONDER_ROOM 999
#define MOVE_AUTOTOMIZE 999
#define MOVE_RAGE_POWDER 999
#define MOVE_TELEKINESIS 999
#define MOVE_MAGIC_ROOM 999
#define MOVE_SMACK_DOWN 999
#define MOVE_FLAME_BURST 999
#define MOVE_SYNCHRONOISE 999
#define MOVE_ELECTRO_BALL 999
#define MOVE_SOAK 999
#define MOVE_SIMPLE_BEAM 999
#define MOVE_ENTRAINMENT 999
#define MOVE_AFTER_YOU 999
#define MOVE_ROUND 999
#define MOVE_CHIP_AWAY 999
#define MOVE_CLEAR_SMOG 999
#define MOVE_STORED_POWER 999
#define MOVE_QUICK_GUARD 999
#define MOVE_ALLY_SWITCH 999
#define MOVE_HEAL_PULSE 999
#define MOVE_SKY_DROP 999
#define MOVE_SHIFT_GEAR 999
#define MOVE_CIRCLE_THROW 999
#define MOVE_QUASH 999
#define MOVE_REFLECT_TYPE 999
#define MOVE_RETALIATE 999
#define MOVE_FINAL_GAMBIT 999
#define MOVE_BESTOW 999
#define MOVE_WATER_PLEDGE 999
#define MOVE_FIRE_PLEDGE 999
#define MOVE_GRASS_PLEDGE 999
#define MOVE_HEART_STAMP 999
#define MOVE_HORN_LEECH 999
#define MOVE_LEAF_TORNADO 999
#define MOVE_NIGHT_DAZE 999
#define MOVE_PSYSTRIKE 999
#define MOVE_HEAD_CHARGE 999
#define MOVE_GEAR_GRIND 999
#define MOVE_SEARING_SHOT 999
#define MOVE_TECHNO_BLAST 999
#define MOVE_RELIC_SONG 999
#define MOVE_SECRET_SWORD 999
#define MOVE_GLACIATE 999
#define MOVE_BOLT_STRIKE 999
#define MOVE_BLUE_FLARE 999
#define MOVE_FIERY_DANCE 999
#define MOVE_FREEZE_SHOCK 999
#define MOVE_ICE_BURN 999
#define MOVE_V_CREATE 999
#define MOVE_FUSION_FLARE 999
#define MOVE_FUSION_BOLT 999
#define MOVE_FLYING_PRESS 999
#define MOVE_MAT_BLOCK 999
#define MOVE_BELCH 999
#define MOVE_ROTOTILLER 999
#define MOVE_STICKY_WEB 999
#define MOVE_FELL_STINGER 999
#define MOVE_TRICK_OR_TREAT 999
#define MOVE_ION_DELUGE 999
#define MOVE_PARABOLIC_CHARGE 999
#define MOVE_FORESTS_CURSE 999
#define MOVE_PARTING_SHOT 999
#define MOVE_TOPSY_TURVY 999
#define MOVE_CRAFTY_SHIELD 999
#define MOVE_FLOWER_SHIELD 999
#define MOVE_GRASSY_TERRAIN 999
#define MOVE_MISTY_TERRAIN 999
#define MOVE_ELECTRIFY 999
#define MOVE_FAIRY_LOCK 999
#define MOVE_KINGS_SHIELD 999
#define MOVE_DIAMOND_STORM 999
#define MOVE_STEAM_ERUPTION 999
#define MOVE_HYPERSPACE_HOLE 999
#define MOVE_WATER_SHURIKEN 999
#define MOVE_SPIKY_SHIELD 999
#define MOVE_AROMATIC_MIST 999
#define MOVE_VENOM_DRENCH 999
#define MOVE_POWDER 999
#define MOVE_GEOMANCY 999
#define MOVE_MAGNETIC_FLUX 999
#define MOVE_HAPPY_HOUR 999
#define MOVE_ELECTRIC_TERRAIN 999
#define MOVE_CELEBRATE 999
#define MOVE_HOLD_HANDS 999
#define MOVE_HOLD_BACK 999
#define MOVE_INFESTATION 999
#define MOVE_OBLIVION_WING 999
#define MOVE_THOUSAND_ARROWS 999
#define MOVE_THOUSAND_WAVES 999
#define MOVE_LANDS_WRATH 999
#define MOVE_LIGHT_OF_RUIN 999
#define MOVE_ORIGIN_PULSE 999
#define MOVE_PRECIPICE_BLADES 999
#define MOVE_DRAGON_ASCENT 999
#define MOVE_HYPERSPACE_FURY 999
#define MOVE_SHORE_UP 999
#define MOVE_BANEFUL_BUNKER 999
#define MOVE_SPIRIT_SHACKLE 999
#define MOVE_SPARKLING_ARIA 999
#define MOVE_ICE_HAMMER 999
#define MOVE_FLORAL_HEALING 999
#define MOVE_STRENGTH_SAP 999
#define MOVE_SPOTLIGHT 999
#define MOVE_LASER_FOCUS 999
#define MOVE_GEAR_UP 999
#define MOVE_THROAT_CHOP 999
#define MOVE_ANCHOR_SHOT 999
#define MOVE_PSYCHIC_TERRAIN 999
#define MOVE_FIRE_LASH 999
#define MOVE_POWER_TRIP 999
#define MOVE_BURN_UP 999
#define MOVE_SPEED_SWAP 999
#define MOVE_PURIFY 999
#define MOVE_REVELATION_DANCE 999
#define MOVE_CORE_ENFORCER 999
#define MOVE_TROP_KICK 999
#define MOVE_INSTRUCT 999
#define MOVE_BEAK_BLAST 999
#define MOVE_CLANGING_SCALES 999
#define MOVE_SHELL_TRAP 999
#define MOVE_FLEUR_CANNON 999
#define MOVE_STOMPING_TANTRUM 999
#define MOVE_ACCELEROCK 999
#define MOVE_PRISMATIC_LASER 999
#define MOVE_SPECTRAL_THIEF 999
#define MOVE_SUNSTEEL_STRIKE 999
#define MOVE_MOONGEIST_BEAM 999
#define MOVE_ZING_ZAP 999
#define MOVE_NATURES_MADNESS 999
#define MOVE_MULTI_ATTACK 999
#define MOVE_MIND_BLOWN 999
#define MOVE_PLASMA_FISTS 999
#define MOVE_PHOTON_GEYSER 999
#define MOVE_ZIPPY_ZAP 999
#define MOVE_SPLISHY_SPLASH 999
#define MOVE_FLOATY_FALL 999
#define MOVE_PIKA_PAPOW 999
#define MOVE_BOUNCY_BUBBLE 999
#define MOVE_BUZZY_BUZZ 999
#define MOVE_SIZZLY_SLIDE 999
#define MOVE_GLITZY_GLOW 999
#define MOVE_BADDY_BAD 999
#define MOVE_SAPPY_SEED 999
#define MOVE_FREEZY_FROST 999
#define MOVE_SPARKLY_SWIRL 999
#define MOVE_VEEVEE_VOLLEY 999
#define MOVE_DOUBLE_IRON_BASH 999
#define MOVE_DYNAMAX_CANNON 999
#define MOVE_SNIPE_SHOT 999
#define MOVE_JAW_LOCK 999
#define MOVE_STUFF_CHEEKS 999
#define MOVE_NO_RETREAT 999
#define MOVE_TAR_SHOT 999
#define MOVE_MAGIC_POWDER 999
#define MOVE_DRAGON_DARTS 999
#define MOVE_TEATIME 999
#define MOVE_OCTOLOCK 999
#define MOVE_BOLT_BEAK 999
#define MOVE_FISHIOUS_REND 999
#define MOVE_COURT_CHANGE 999
#define MOVE_CLANGOROUS_SOUL 999
#define MOVE_DECORATE 999
#define MOVE_DRUM_BEATING 999
#define MOVE_SNAP_TRAP 999
#define MOVE_PYRO_BALL 999
#define MOVE_BEHEMOTH_BLADE 999
#define MOVE_BEHEMOTH_BASH 999
#define MOVE_AURA_WHEEL 999
#define MOVE_BRANCH_POKE 999
#define MOVE_OVERDRIVE 999
#define MOVE_APPLE_ACID 999
#define MOVE_GRAV_APPLE 999
#define MOVE_STRANGE_STEAM 999
#define MOVE_LIFE_DEW 999
#define MOVE_OBSTRUCT 999
#define MOVE_FALSE_SURRENDER 999
#define MOVE_METEOR_ASSAULT 999
#define MOVE_ETERNABEAM 999
#define MOVE_EXPANDING_FORCE 999
#define MOVE_STEEL_ROLLER 999
#define MOVE_SHELL_SIDE_ARM 999
#define MOVE_MISTY_EXPLOSION 999
#define MOVE_GRASSY_GLIDE 999
#define MOVE_RISING_VOLTAGE 999
#define MOVE_TERRAIN_PULSE 999
#define MOVE_BURNING_JEALOUSY 999
#define MOVE_LASH_OUT 999
#define MOVE_POLTERGEIST 999
#define MOVE_CORROSIVE_GAS 999
#define MOVE_COACHING 999
#define MOVE_JUNGLE_HEALING 999
#define MOVE_WICKED_BLOW 999
#define MOVE_SURGING_STRIKES 999
#define MOVE_THUNDER_CAGE 999
#define MOVE_DRAGON_ENERGY 999
#define MOVE_FREEZING_GLARE 999
#define MOVE_FIERY_WRATH 999
#define MOVE_THUNDEROUS_KICK 999
#define MOVE_GLACIAL_LANCE 999
