...
u8 LONG_CALL CalcSpeed(void *bw, struct BattleStruct *sp, int client1, int client2, int flag)
{
    ...
    if (hold_effect1 == HOLD_EFFECT_SOMETIMES_PRIORITY && quick_claw1 == 0) /**** AURORA CRYSTAL: Ignore Quick Claw if Quick Draw activated. ***/
    {
    ...
    if (hold_effect1 == HOLD_EFFECT_PINCH_PRIORITY && quick_claw1 == 0) /**** AURORA CRYSTAL: Ignore Custap Berry if Quick Draw activated. ***/
    {
    ...
    if (hold_effect2 == HOLD_EFFECT_SOMETIMES_PRIORITY && quick_claw2 == 0) /**** AURORA CRYSTAL: Ignore Quick Claw if Quick Draw activated. ***/
    {
    ...
    if (hold_effect2 == HOLD_EFFECT_PINCH_PRIORITY && quick_claw2 == 0) /**** AURORA CRYSTAL: Ignore Custap Berry if Quick Draw activated. ***/
    {
    ...
    if (flag == 0)
    {
        ...
        /**** AURORA CRYSTAL: Scuffed way of making Gems show the item animation prior to the move via the Quick Claw subscript. */
...
int CalcCritical(void *bw, struct BattleStruct *sp, int attacker, int defender, int critical_count, u32 side_condition)
{
    ...
    temp = (((condition2 & STATUS2_FOCUS_ENERGY) != 0) * 2) + (hold_effect == HOLD_EFFECT_CRITRATE_UP) + critical_count + (isCritBoostingAbility)
